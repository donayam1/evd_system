...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'home', loadChildren: './admin-home/admin-home.module#AdminHomeModule', canActivate: [AuthGuard] },
      { path: 'login', component: LoginComponent, canActivate: [LoginPageGardService] },
      {
  ...
  providers: [
    ...
    {
      provide: externalUrlProvider, useValue: (route: ActivatedRouteSnapshot) => {
